...
contract('Exchange', ([deployer, feeAccount, user1, user2] )=> {
    ...
    describe('withdraw Ether',async () => {
        ...
        describe('failure', async () => {
            it('rejects withdraw for insufficent balances', async() => {
    ...
    describe('making orders', async () => {
        ...
        it('tracks the newly created order', async () => {
            ...
            order.timestamp.toString().length.should.be.at.least(1, 'timestamt is present')
        })

        it('emits an "Order" event', async () => {
            console.log("THIS IS THE RESULT OF MAKEORDER", result)
            const log = result.logs[0]
            log.event.should.equal('Order')
            console.log("THIS SHOULD NOT BE UNDEFINED", log)
            const event = log.args
            console.log("THIS SHOULD HAVE LOGS: ", event)
            ...
            event.timestamp.toString().length.should.be.at.least(1, 'timestamt is present')
        })
