...
export const loadWeb3 = (dispatch) => {
    ...
    // old way: new Web3(Web3.givenProvider || `http://localhost:7545`)
...
export const loadToken = async (web3, networkID, dispatch) => {
    try {
        ...
        console.log("Contract not toployed to the current network. please select another network in metamask")
        return null
    }
}
